...
public class CoverArt {
	...
	public static void setup() {
		...
		try {
			catLogo = new Image(CoverArt.class.getClassLoader().getResource("resources/mcatTransparent.png").openStream());
			catLogoBlack = new Image(CoverArt.class.getClassLoader().getResource("resources/mcatTransparentBlack.png").openStream());
		} catch (IOException e) {
			e.printStackTrace();
		}
